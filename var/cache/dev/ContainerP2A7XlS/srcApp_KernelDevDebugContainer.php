...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\BookListController' => 'getBookListControllerService',
    ...
    /**
     * Gets the public 'App\Controller\BookListController' shared autowired service.
     *
     * @return \App\Controller\BookListController
     */
    protected function getBookListControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\BookListController.php';

        $this->services['App\\Controller\\BookListController'] = $instance = new \App\Controller\BookListController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'session' => '?',
            'twig' => '?',
        ]))->withContext('App\\Controller\\BookListController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('un90WMQI7u', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WEIMXXK6Rg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    /**
     * Gets the private '.service_locator.EEh4gf4' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_EEh4gf4Service()
    {
        return $this->privates['.service_locator.EEh4gf4'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\BookListController::update' => ['privates', '.service_locator..j7DS4F', 'get_ServiceLocator__J7DS4FService', false],
            'App\\Controller\\BookListController:update' => ['privates', '.service_locator..j7DS4F', 'get_ServiceLocator__J7DS4FService', false],
        ], [
            'App\\Controller\\BookListController::update' => '?',
            'App\\Controller\\BookListController:update' => '?',
        ]);
    }

    /**
     * Gets the private 'App\Form\AddBookType' shared autowired service.
     *
     * @return \App\Form\AddBookType
     */
    protected function getAddBookTypeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\AbstractType.php';
        include_once \dirname(__DIR__, 4).'\\src\\Form\\AddBookType.php';

        return $this->privates['App\\Form\\AddBookType'] = new \App\Form\AddBookType();
    }

    /**
     * Gets the private 'App\Form\EditBookType' shared autowired service.
     *
     * @return \App\Form\EditBookType
     */
    protected function getEditBookTypeService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\form\\AbstractType.php';
        include_once \dirname(__DIR__, 4).'\\src\\Form\\EditBookType.php';

        return $this->privates['App\\Form\\EditBookType'] = new \App\Form\EditBookType();
    }
    ...
    protected function getCache_AnnotationsService()
    {
        ...
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lqPp+b+hzU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.EEh4gf4'] ?? $this->get_ServiceLocator_EEh4gf4Service())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getForm_RegistryService()
    {
        ...
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Form\\AddBookType' => ['privates', 'App\\Form\\AddBookType', 'getAddBookTypeService', false],
            'App\\Form\\EditBookType' => ['privates', 'App\\Form\\EditBookType', 'getEditBookTypeService', false],
            ...
            'App\\Form\\AddBookType' => '?',
            'App\\Form\\EditBookType' => '?',
